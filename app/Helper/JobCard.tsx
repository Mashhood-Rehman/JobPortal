        ...
        <div className='flex items-center space-x-6'>
            ...
            <div>
                ...
                <div className=' flex items-center space-x-2 sm:space-x-4 mt-[1rem]'>
                    ...
                    <div className='text-[10px] sm:text-[14px] text-black text-opacity-80 px-3 sm:px-6 py-1 rounded-full bg-opacity-30 font-semibold capitalize  bg-blue-400'>Private</div>

                    <div className='text-[10px] sm:text-[14px] text-black text-opacity-80 px-3 sm:px-6 py-1 rounded-full bg-opacity-30 font-semibold capitalize  bg-red-400'>Urgent</div>
